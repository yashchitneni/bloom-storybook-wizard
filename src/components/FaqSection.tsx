...
const FaqItem = ({
  ...
  return <div className="border-b border-gray-200 py-4">
      <button className="flex justify-between items-center w-full text-left focus:outline-none" onClick={toggleOpen}>
        ...
        <ChevronDown className={cn("h-5 w-5 text-gray-500 transition-transform duration-300", isOpen && "transform rotate-180")} />
      </button>
      
      <div className={cn("overflow-hidden transition-all duration-300 mt-2", isOpen ? "max-h-96" : "max-h-0")}>
  ...
  return <section className="py-16 bg-white">
      <div className="container px-4 md:px-6 max-w-3xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-2 text-gray-600">Everything you need to know about DearKidBooks</p>
        </div>
